...
export const AnimatedBackground = React.memo(() => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-white">
      ...
      {/* Soft Moving Blobs */}
      <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] rounded-full bg-gradient-to-br from-primary/10 to-transparent blur-[120px] mix-blend-multiply animate-[pulse_8s_ease-in-out_infinite]"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-gradient-to-tr from-secondary/10 to-transparent blur-[140px] mix-blend-multiply animate-[pulse_10s_ease-in-out_infinite_2s]"></div>

      <Canvas camera={{ position: [0, 0, 15], fov: 60 }} dpr={[1, 2]} className="z-0 opacity-80">
        <ambientLight intensity={1.5} color="#ffffff" />
        <directionalLight position={[10, 15, 10]} intensity={1.5} color="#0EA5A8" />
        <directionalLight position={[-10, 0, -5]} intensity={1.5} color="#09475f" />
