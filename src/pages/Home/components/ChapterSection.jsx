        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {stats2.map((s, i) => (
            <SlideUp delay={i * 0.15} key={i}>
              <div className="border border-white/20 bg-white/10 backdrop-blur-lg text-white rounded-[24px] md:rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center text-center shadow-xl hover:bg-secondary/30 hover:border-secondary hover:shadow-2xl transition-all duration-300 group">
                <s.icon className="w-8 h-8 md:w-10 md:h-10 mb-4 transition-colors duration-300 text-secondary group-hover:text-white" strokeWidth={1.5} />
