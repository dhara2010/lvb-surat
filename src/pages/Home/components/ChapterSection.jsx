      ...
      <div className="container-xl">
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          <SlideUp delay={0.2} className="flex-1 w-full">
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F3A] mb-5 leading-tight">LVB Surat Platinum Chapter</h2>
            <div className="w-16 h-[5px] bg-[#0B1F3A] mb-7 rounded-sm"></div>
            <p className="text-gray-600 mb-8 leading-relaxed text-base md:text-lg">Established on 17 October 2020, LVB Surat Platinum Chapter is a premium business networking community under LVB that brings together entrepreneurs, professionals, and business leaders on a trusted platform. The chapter focuses on meaningful connections, quality referrals, and collaborative growth, helping members expand their business through strong relationships and structured networking.</p>
            ...
            <Link
              to="/about"
              className="mt-3 group relative inline-flex items-center gap-3 overflow-hidden rounded-full px-8 py-4 font-semibold text-white shadow-lg transition-all duration-500 hover:shadow-2xl"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats2.map((s, i) => (
            <SlideUp delay={i * 0.15} key={i}>
              <div className="border-[3px] border-[#0B1F3A] bg-white text-[#0B1F3A] rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-sm hover:bg-[#D1FAE5] hover:text-[#0B1F3A] hover:border-[#14B8A6] transition-all duration-300 group">                <s.icon className="w-10 h-10 mb-4 transition-colors duration-300" strokeWidth={1.5} />
