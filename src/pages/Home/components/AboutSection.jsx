    ...
    <section className="relative overflow-hidden py-32">
      <div className="relative max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
          <div>
            <SlideUp delay={0.1}>
              <span className="inline-flex items-center gap-3 font-semibold tracking-[2px] md:tracking-[4px] uppercase text-secondary text-xs md:text-sm">
                <div className="w-8 md:w-14 h-[2px] bg-secondary"></div>
                About Chapter
              </span>
            </SlideUp>
            <SlideUp delay={0.2}>
            ...
            <div className="mt-8 md:mt-12 space-y-6 md:space-y-8">{[
              ...
              <SlideUp key={index} delay={0.4 + index * 0.1}>
                <div className="flex items-start gap-4 md:gap-5">
                  <div className="relative shrink-0">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-secondary text-white flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 md:w-6 md:h-6" />
                    </div>
                    {index !== 2 && (
                      <div className="absolute left-1/2 top-10 md:top-12 w-[2px] h-10 md:h-12 bg-secondary -translate-x-1/2"></div>
                    )}
                  </div>
                  <div>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 min-h-[300px]">
              {stats1.map((item, index) => (
                <SlideUp key={index} delay={0.4 + index * 0.15} className={`h-full ${index === 0 ? "sm:col-span-2" : ""}`}>
                  <div className="h-full rounded-[24px] md:rounded-[35px] backdrop-blur-xl bg-white/10 border border-white/20 shadow-xl md:shadow-2xl p-6 md:p-8 lg:p-10 transition duration-500 hover:-translate-y-2 lg:hover:-translate-y-3 hover:bg-white/20 hover:border-white/30">
