...
<<<<<<< HEAD
                    ...
                    <div className="flex flex-col gap-2.5">
                      <label className="text-[11px] font-black uppercase tracking-[0.2em] text-primary ml-1" htmlFor="contact-company">Business Name *</label>
...
<<<<<<< HEAD
                    ...
                    <div className="flex flex-col gap-2.5">
                      <label className="text-[11px] font-black uppercase tracking-[0.2em] text-primary ml-1" htmlFor="contact-email">Email Address *</label>
...
<<<<<<< HEAD
                    ...
                    <div className="flex flex-col gap-2.5">
                      <label className="text-[11px] font-black uppercase tracking-[0.2em] text-primary ml-1" htmlFor="contact-referral">Referred By (Optional)</label>
