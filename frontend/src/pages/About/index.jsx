      ...
      <div className="bg-white py-24 border-y border-gray-100">
        <Container>
          ...
          <ScrollReveal3D delay={0.4} className="max-w-4xl mx-auto text-center">
            <div className="relative p-10 md:p-14 bg-gradient-to-br from-primary to-dark rounded-[40px]  shadow-2xl overflow-hidden">
              {/* Pattern overlay */}
              ...
              <p className="relative z-10 text-lg md:text-xl/relaxed  italic font-light">
                {founderMessage}
              </p>
