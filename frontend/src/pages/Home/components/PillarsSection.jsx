    ...
    <GlassSection>
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10 w-full flex-grow">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-12 md:mb-20">
          <TypingHeading el="h2" className="text-3xl md:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.2] lg:leading-[1.1] mb-4 md:mb-6">
            The Foundation of Our <span>Community</span>
          </TypingHeading>
          <TextReveal delay={0.2} splitBy="word" el="p" className="text-sm md:text-lg lg:text-xl font-light mx-auto max-w-[600px] leading-relaxed drop-shadow px-2">
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              <LuxuryCard className="group flex sm:flex-col items-center sm:text-center p-5 md:p-6 h-full gap-4 sm:gap-0 min-h-[220px]">
                ...
                {/* Icon Container */}
                <div className="relative z-10 w-12 h-12 sm:w-16 sm:h-16 shrink-0 rounded-full flex items-center justify-center sm:mb-8 transition-all duration-300 group-hover:scale-110 group-hover:rotate-[8deg]" style={{ background:'rgba(255,255,255,0.05)', }}>
                  <pillar.icon className="w-6 h-6 sm:w-7 sm:h-7 stroke-[1.5] group-hover:text-gray-400 transition-colors" />
                </div>
                ...
                <div className="relative z-10 flex flex-col sm:items-center sm:mt-2 text-left sm:text-center w-full">
                  ...
                  <div className="w-0 h-[2px] rounded-full mt-2 sm:mt-4 group-hover:w-12 transition-all duration-500 ease-out hidden sm:block group-hover:bg-transparent" style={{ backgroundColor:'#4FA3D1' }}></div>
                </div>
              </LuxuryCard>
            </motion.div>
          ))}
