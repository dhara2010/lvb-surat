...
export default function TestimonialsSection() {
  ...
  const getVariants = (dir) => {
    if (isMobile) {
      return {"0": { x: 0, y: 0, opacity: 1, scale: 1, zIndex: 10, transition: { duration: 0.3 } },"1": { x: 0, y: 0, opacity: 0, scale: 1, zIndex: 9, transition: { duration: 0.3 } },"2": { x: 0, y: 0, opacity: 0, scale: 1, zIndex: 8, transition: { duration: 0.3 } },"3": { x: 0, y: 0, opacity: 0, scale: 1, zIndex: 7, transition: { duration: 0.3 } }
      };
    }
    return {"0": {
