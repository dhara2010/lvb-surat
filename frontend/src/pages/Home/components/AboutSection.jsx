                ...
                {[
                  ...
                  <ScrollReveal3D key={index} delay={0.4 + index * 0.1}>
                    <LuxuryCard className="h-full p-6">
                      <div className="shrink-0 w-14 h-14 rounded-md flex items-center justify-center transition-all duration-500 group-hover:bg-transparent group-hover:text-primary mb-6" >
                ...
                {stats1[0] && (
                  ...
                  >
                    <LuxuryCard className="w-full min-h-[320px] p-10 sm:p-14 flex flex-col justify-between group">
                      <div className="w-20 h-20 rounded-lg flex items-center justify-center mb-10 relative z-20 group-hover:bg-transparent group-hover:text-primary transition-all duration-500" >
                  ...
                  {stats1.slice(1, 3).map((item, index) => (
                    ...
                    >
                      <LuxuryCard className="w-full min-h-[260px] p-8 flex flex-col justify-between group">
                        <div className="w-16 h-16 rounded-md flex items-center justify-center mb-8 relative z-20 group-hover:bg-transparent group-hover:text-primary transition-all duration-500" >
